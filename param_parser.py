...
def parameter_parser():
    parser = argparse.ArgumentParser(description="Run MLTPOI.")
    ...
    parser.add_argument('--data-adj-mtx',
                        type=str,
                        default='dataset/Foursquare/graph_A.csv',
                        help='Graph adjacent path')
    parser.add_argument('--data-node-feats',
                        type=str,
                        default='dataset/Foursquare/graph_X.csv',
                        help='Graph node features path')
    parser.add_argument('--data-train',
                        type=str,
                        default='dataset/Foursquare/Foursquare_train.csv',
                        help='Training data path')
    parser.add_argument('--data-val',
                        type=str,
                        default='dataset/Foursquare/Foursquare_val.csv',
    ...
    parser.add_argument('--poi-dist-thre',
                        type=int,
                        default=1,
    ...
    parser.add_argument('--name',
                        default='Foursquare_a05_gmlp_model',
                        help='save to project/name')
